...
def render_state_card(title, state, action_href, action_label):
...
<body>
  <div class="wrap">
    ...
    <div class="grid-two">
      {render_state_card("外置开机观察", snapshot["boot"], "http://192.168.0.108:30088", "打开集群内 Portal")}
      {render_state_card("外置关机观察", snapshot["shutdown"], POWER_SEQUENCE_URL, "打开开关机顺序")}
    </div>
